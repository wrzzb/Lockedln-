...
// Give the driver more time to detect/recover a stale connection before
// queries give up — the default 10s buffering timeout was firing right as
// the heartbeat (also ~10s) was about to notice the dead socket and reconnect.
